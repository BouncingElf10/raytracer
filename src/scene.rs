...
use glam::Vec3;
use crate::bvh::{construct_bvh, SplitHeuristic};
...
pub fn create_scene() -> Scene {
    ...
    mesh.add_bvh(construct_bvh(&mesh, SplitHeuristic::SurfaceAreaHeuristic));
...
pub fn create_scene_quay() -> Scene {
    ...
    mesh.add_bvh(construct_bvh(&mesh, SplitHeuristic::Random));
    scene.add_object(Box::new(mesh));
